...
public void deletefile(String deletefile) {
	File f1=new File("root1"+"/"+deletefile+".txt") ;
	  if(f1.delete()) 
	  {
...
public void add(String addfile)   {
	...
	File f2= new File("root1"+"/"+addfile+".txt");
			if(f2.exists()) 
			{
		...
		System.out.println("file created of file name"+" "+addfile+".txt");
}}
public void search(String searchfile) {
	File f3=new File("root1"+"/"+searchfile+".txt");
			if(f3.exists())
			{
